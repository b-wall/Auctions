    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_initial_bid', models.DecimalField(decimal_places=2, default=0.0, max_digits=14)),
                ('item_current_bid', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=14, null=True)),
                ('item_isactive', models.BooleanField(default=True)),
                ('item_created', models.DateTimeField(auto_now_add=True)),
                ('item_buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='buyer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commentlisting', to='auctions.auction_listing')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=14, null=True)),
                ('auctions', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auction', to='auctions.auction_listing')),
